...
public class StockOutFacilityProductService {
    //    final  FacilityDAO facilityDAO;
    //    final CTFMainDAO ctfMainDAO;
    //    final CTFItemDAO ctfItemDAO;
    //    public StockOutFacilityProductService(FacilityDAO facilityDAO
    //                                          , CTFMainDAO ctfMainDAO
    //                                          , CTFItemDAO ctfItemDAO) {
    //        super();
    //        this.ctfItemDAO = ctfItemDAO;
    //        this.ctfMainDAO = ctfMainDAO;
        ...
        try {
            ...
            for (Facility facility : facilityOfSupplierList) {
                ...
                for (CTFMain ctfMain : ctfMainList) {
                    ...
                    condition = CheckCTFItems1( ctfItemList);
                    if(condition)
                        break;
                    else
                        continue;
