...
public class FacilityProductDispensedReportV1 {
    public FacilityProductDispensedReportV1() {
        super();
    }
    ...
    public static List<FacilityTemplate> getFacilityDispensedRepAllIntersect(String mon, String year, String products[],
                                                                             ...
                                                                             String[] centers) {
           return UtilsClass.getFacilityDispensedRepAllIntersect(mon, year, products, dat, fY, tY, fM, tM, type, hq, supplierID, centers);
