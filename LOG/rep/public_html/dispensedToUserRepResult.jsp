    ...
    %>
        ...
        <div class="contentpage">
            <div style="clear:both">
                <b>Total for Whole Country:
                    <%= df.format(sumWhole) %></b>
            </div>
            <br/>
            <div align="center" style="clear:both;font-weight:bold; font-size:14pt;">
                <%= db.getProdName(prod[pr]) + "      " + db.getProdDose(prod[pr]) %>
            </div>
...
//here1  All Facilities%>
                    ...
                    <tr style="border:0; font-size:9pt;font-weight:bold;font-style:italic">
                        <td>Dispensed By:</td>
                    </tr>
                </thead>
...
//here1  All Facilities%>
 ...
 if(type.equals("7"))
    if( (supplier.getFacilityId()+"").equals("498"))
     if(!facility.getFacilityTypeHierarchyId().equals("7"))
     continue;
...
%>
                ...
                <tr class="row_titles">
                    <td colspan="2" align="center">
                        <h4 style="margin-left:20%;clear:both">
                            Total for
                            <%= supplierName %>
                            :
                        </h4>
                    ...
                    <td align="center" style="font-weight:bold">100.00%</td>
                </tr>
            </table>
            <br/><br/><br/>
        </div>
