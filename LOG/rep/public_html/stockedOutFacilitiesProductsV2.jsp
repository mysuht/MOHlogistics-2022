...
<%@ page contentType="text/html;charset=windows-1256"
         import="com.logistics.lib.report.StockOutFacilityProductServiceV2, moh.logistics.lib.reports.code.FacilityTemplate , java.util.* , java.sql.*, java.text.*" %>
<html>
    <head>
...
String hq = "";
   ...
   quart = request.getParameter("p_quart");
    ...
    hq = request.getParameter("p_hq");
      ...
      String product= "";
            ...
            if(i==0){
                product = StockOutFacilityProductServiceV2.getProdName(products[i]);
                }else{
            product += ", " + StockOutFacilityProductServiceV2.getProdName(products[i]);
                    }
                    }
  ...
  Report Period:
   ...
   <%
    ...
    out.println("All Facility Types.");
        ...
        List<FacilityTemplate> facilityTemplateList = StockOutFacilityProductServiceV2.getFacTypesMainName(type); 
  ...
  <br>
   <%= product %>
     ...
     <div class="dRight">
    Run Date: <%=  StockOutFacilityProductServiceV2.getDate() %> <br/>
    Run Time: <%= StockOutFacilityProductServiceV2.getTime() %>
    </div>
    </div>
   <br/><br/><br/>
<br/><br/>
...
List<FacilityTemplate> directoratesList = StockOutFacilityProductServiceV2.getDirectoratesList(dir);
...
StockOutFacilityProductServiceV2.getStockOutFacilityProducts( (quart + "") , year, dat,  fY,  tY,  fM,  tM,  hq,  products, directorateId, dir); 
