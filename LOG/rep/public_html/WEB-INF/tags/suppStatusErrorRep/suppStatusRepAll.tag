...
<% 
     ...
     int suppReceiptsSumm = str.getSupplyStatusRepBySupplierReceipts(suppFacilityId, mon, year, prod[p], dat,fY,tY, fM, tM,"supp", hq, Directorates, type);
   ...
   String suppAdjustments = suppData.get("adj") + "";
      ...
      if (suppReceiptsSumm == Integer.parseInt(suppIssues))
      continue;
