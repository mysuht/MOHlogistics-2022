...
<%@ page contentType="text/html;charset=windows-1256"
         import="java.util.*, moh.logistics.lib.reports.code.FacilityTemplate ,moh.logistics.lib.reports.code.ProgramProductDispensingReport ,moh.logistics.lib.reports.code.LogisticsReportsClass, java.sql.*, java.text.*" %>
<html>
    <head>
...
int counts = db.getProgDispensedRepAllIntersect(quart, year, products,dat,fY,tY, fM, tM,type, hq, facility.getFacilityId()+"");
if(counts == 0)
continue;
%>
