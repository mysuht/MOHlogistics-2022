...
SupplyStatusReport str = new SupplyStatusReport();
    ...
    for(FacilityTemplate directorate : directorateList){
       ...
       //String suppFacilityId = directorate.getSupCode().toString();
   ...
   int supplierSumReciepts = 0;
   for(FacilityTemplate fD: supplyStatusReportList){
   supplierSumReciepts += Integer.parseInt( fD.getReceipts().toString());
   }

        if(supplierSumReciepts == Integer.parseInt(supplierIssues))
        continue;
    %>
