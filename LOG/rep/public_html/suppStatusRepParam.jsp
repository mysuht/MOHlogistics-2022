...
<html>
   ...
   ResultSet rsDir = db.getDirectorates();
    ...
    %>
    <form method="get" action="supStatusRepResult.jsp" >
  <div style="width:325pt;float:left" >
     Directorates: &nbsp; <select name="p_dir" class="sel_beh" multiple="multiple" id="pDir">
    <%
    while(rsDir.next()){
    %>
   ...
   for(int i=1997; i<=2014; i++){
    ...
    <input type="submit" value="   View   "     style = "margin-top:20pt;" />
