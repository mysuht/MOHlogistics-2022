...
<html>
   ...
   ResultSet rsDir = db.getDirectorates();
    ...
    %>
    <form method="post" action="facilityProductDispensedRepResult.jsp" >
    ...
    <div style="clear: both; width:100% ">
     ...
     Directorates: &nbsp; <select name="p_dir" class="sel_beh" id="pProd" multiple="multiple">
    <%
    while(rsDir.next()){
    %>
    ...
    <div style="width:200pt;float:left" >
     Product: &nbsp; <select name="p_prod" class="sel_beh" id="pProd" >
    <%
    while(rsProd.next()){
    %>
