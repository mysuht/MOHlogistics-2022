...
<html>
    ...
    %>
    <form method="get" action="dispensedToUserRepResult.jsp" >
    ...
    <div>
    <div style="width:330pt;float:left" >
     Directorates: &nbsp; <select name="p_dir" class="sel_beh">
    <%
    while(rsDir.next()){
    %>
    ...
    <div style="width:160pt;float:left" >
