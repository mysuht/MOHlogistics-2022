...
<html>
    ...
    %>
    <form method="post" action="stockedOutFacilitiesProductsResult.jsp" >
  <div style="width:350pt;float:left" >
     Supplier: &nbsp; <select name="p_dir" class="sel_beh" id="pDir"  multiple="multiple">
    <%
    while(rsDir.next()){
    %>
   ...
   for(int i=1997; i<=2014; i++){
    ...
    <%}%>
     ...
     <div style="width:150pt;float:left;display:none">
    Month: &nbsp; <select name="p_mon" class="sel_beh">
    <option></option>
    <%
    for(int i=1; i<=12 ; i++){
